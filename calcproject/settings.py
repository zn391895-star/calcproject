...
SECRET_KEY = 'django-insecure-3x&4ifj$^#i-%ce=e(0wk3hul9cr$u80&@@p_a*55$xz$2g1&e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "templates"],  # 👈 yahan add karo
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGOUT_REDIRECT_URL = '/login/'   # ya tumhare login page ka URL
